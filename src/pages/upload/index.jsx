                            ...
                            <Table size="small" stickyHeader>
                                ...
                                <TableBody>
                                    {enrichedData.data.map((vehicle, index) => {
                                        ...
                                        // Crear fila usando la nueva estructura simplificada
                                        const row = {
                                            patente: enrichedDataItem.patente || "",
                                            kilometros: enrichedDataItem.kilometros || "",
                                            vehiculo_ano: enrichedDataItem.vehiculo_ano || "",
                                            valor: enrichedDataItem.valor || "",
                                            moneda: enrichedDataItem.moneda || "",
                                            publicacion_web: enrichedDataItem.publicacion_web || "",
                                            publicacion_api_call: enrichedDataItem.publicacion_api_call || "",
                                            marca: enrichedDataItem.marca || "",
                                            modelo: enrichedDataItem.modelo || "",
