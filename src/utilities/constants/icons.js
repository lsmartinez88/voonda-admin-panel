...
import { RiAdvertisementLine, RiBuildingLine, RiListView, RiLockPasswordLine, RiMailLine, RiMoneyDollarCircleLine, RiNotificationLine, RiSecurePaymentLine, RiShieldKeyholeLine, RiTeamLine, RiUser6Line } from "react-icons/ri"
...
const APP_ICONS = [
    ...
    {
        name: "upload",
        Component: CloudUploadOutlinedIcon,
        props: { sx: { fontSize: 20 } }
    },
    {
        name: "sync",
