...
export const CAR_BRANDS = [
  // Marcas Premium/Lujo
  'Audi', 'BMW', 'Mercedes-Benz', 'Lexus', 'Acura', 'Infiniti', 'Cadillac', 'Lincoln',
  
  // Marcas de Lujo/Superautos  
  'Ferrari', 'Lamborghini', 'Porsche', 'Maserati', 'Bentley', 'Rolls-Royce', 'Aston Martin', 'McLaren',
  
  // Marcas Japonesas
  'Toyota', 'Honda', 'Nissan', 'Mazda', 'Subaru', 'Mitsubishi', 'Suzuki', 'Isuzu',
  
  // Marcas Alemanas
  'Volkswagen', 'Opel', 'MINI', 
  
  // Marcas Americanas
  'Ford', 'Chevrolet', 'Dodge', 'Chrysler', 'Jeep', 'RAM', 'GMC', 'Buick',
  
  // Marcas Coreanas
  'Hyundai', 'Kia', 'Genesis', 'SsangYong',
  
  // Marcas Francesas
  'Peugeot', 'Renault', 'Citroën', 'DS',
  ...
  // Marcas Chinas
  'BYD', 'Geely', 'Great Wall', 'Chery', 'JAC', 'MG',
  
  // Marcas de Vehículos Comerciales
  'Iveco', 'Scania', 'Volvo Trucks', 'DAF', 'MAN',
  
  // Marcas Tesla y Eléctricos
  'Tesla', 'Polestar', 'Lucid', 'Rivian',
...
export const getCarBrandLogo = (brand) => {
  ...
  const initials = normalizedBrand.split(' ').map(word => word[0]).join('').substring(0, 2)
...
export const getBrandColor = (brand) => {
  const colors = [
    ...
    '#7b1fa2', '#c2185b', '#00796b', '#303f9f',
    '#5d4037', '#455a64', '#e64a19', '#00acc1'
  ]
